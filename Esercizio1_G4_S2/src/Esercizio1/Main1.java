...
public class Main1 {
	...
	public static void main(String[] args) {
		...
		Ordine o1 = new Ordine(1, "In cosegna", LocalDate.now(), LocalDate.of(2023, 01, 23), ordine1, c1);
		Ordine o2 = new Ordine(2, "In cosegna", LocalDate.of(2021, 03, 01), LocalDate.of(2023, 01, 21), ordine2, c2);
		Ordine o3 = new Ordine(3, "In cosegna", LocalDate.now(), LocalDate.of(2023, 01, 22), ordine3, c3);
		Ordine o4 = new Ordine(4, "In cosegna", LocalDate.of(2021, 02, 12), LocalDate.of(2023, 01, 18), ordine3, c4);
		Ordine o5 = new Ordine(5, "In cosegna", LocalDate.of(2021, 01, 12), LocalDate.of(2023, 10, 03), ordine3, c5);
